...
typedef enum
{
    ...
    IMU_GYRO_ODR_12_5_HZ_LOW_PWR = 0x10,
    IMU_GYRO_ODR_26_HZ_LOW_PWR   = 0x20,
    IMU_GYRO_ODR_52_HZ_LOW_PWR   = 0x30,
    IMU_GYRO_ODR_104_HZ_NORMAL   = 0x40,
    IMU_GYRO_ODR_208_HZ_NORMAL   = 0x50,
    IMU_GYRO_ODR_416_HZ_HIGH_PERF= 0x60,
    IMU_GYRO_ODR_833_HZ_HIGH_PERF= 0x70, // Use this
    IMU_GYRO_ODR_1_66_KHZ_HP     = 0x80,
    IMU_GYRO_ODR_3_33_KHZ_HP     = 0x90,
    IMU_GYRO_ODR_6_66_KHZ_HP     = 0xA0
} IMU_Gyro_ODR;
